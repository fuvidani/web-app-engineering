...
interface IJwtService {
    ...
    /**
     * This method generates a signed JWT for the given AbstractUser.
    ...
    fun generateJwt(user: AbstractUser): String

    /**
     * This method parses the signed JWT and extracts the information from the payload to construct the User.
